@props(['align' => 'right', 'text', 'routes' => [], 'icon', 'scope' => '', 'relative' => 'relative'])
...
@scope($scope)
    <div class=" select-none {{ $relative }}" x-data="{ open: false }" @click.away="open = false" x-cloak>
        ...
        <div class="{{ $alignmentClasses }} absolute   z-50 " x-show="open"
            x-transition:enter="transition ease-out duration-400" x-cloak
