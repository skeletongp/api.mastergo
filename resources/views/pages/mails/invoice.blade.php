                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        class="esd-block-text">
                                                                                        <p>Estimado cliente, a petición,
                                                                                            le remitimos una copia de su Factura no. {{$invoice->number}} con detalle de los
                                                                                            productos y/o servicios
                                                                                            facturados por un monto total de ${{formatNumber($invoice->payment->total)}}. Nos ponemos a
                                                                                            su disposición y agradecemos
                                                                                            su
                                                                                            preferencia.<br><br>Saludos
                                                                                            cordiales.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
