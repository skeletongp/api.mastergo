    <div class="p-4 shadow-xl max-w-6xl w-full flex flex-col space-y-4 justify-end items-start lg:flex-row lg:space-y-0 lg:space-x-4 lg:items-start lg:justify-start px-4 mx-auto">
        <div class="w-1/2">
