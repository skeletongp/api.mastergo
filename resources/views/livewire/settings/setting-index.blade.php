<div class="w-full flex  items-start" x-data="{showOptions: false}">
   
    <div class="  sticky top-24 pt-8 " >
        <div class="flex justify-end w-[10rem] py-2 bg-red-400" :class="showOptions?'justify-start':'justify-end'">
            <span class="fas fa-bars right-0">
            </span>
        </div>
        <div :class="showOptions?'translate-x-0':'-translate-x-[10rem] lg:translate-x-0'"
            class="w-[10rem] lg:w-[16rem] max-w-[16rem] text-xs lg:text-lg font-medium text-gray-900  rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white ">
