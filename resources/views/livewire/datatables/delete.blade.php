            ...
            <div class="w-full">
                <div class="mt-3 text-center">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        {{ __('Eliminación de registro') }} 
                    </h3>
                    <div class="mt-2">
                        <div class="mt-10 text-gray-700 text-xl">
                            {{ __('¿Desea continuar?')}}
                        </div>
                        <div class="mt-10 flex justify-center">
                            <span class="mr-2">
                                ...
                                <button wire:click="delete({{ $value }})" class="w-32 shadow-sm inline-flex justify-center items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:shadow-outline-teal active:bg-blue-700 transition ease-in-out duration-150">
                                    {{ __('Proceder')}}
                                </button>
                        </div>
                    </div>
