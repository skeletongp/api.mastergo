                    ...
                    <ul class="flex justify-center  -mb-px">
                        <li class="mr-2">
                            <span wire:click="$set('activeTab','infoproduct')"
                                class="cursor-pointer text-xs lg:text-base inline-block p-4  rounded-t-lg border-b-2 {{ $activeTab == 'infoproduct' ? 'text-blue-600  border-blue-600 active' : 'border-transparent' }} ">Datos
                                Generales</span>
                        </li>
                        <li class="mr-2">
                            <span wire:click="$set('activeTab','unitsproduct')"
                                class="cursor-pointer text-xs lg:text-base inline-block p-4  rounded-t-lg border-b-2 {{ $activeTab == 'unitsproduct' ? 'text-blue-600  border-blue-600 active' : 'border-transparent' }} ">Medidas
                                y Precios</span>
                        </li>
                    </ul>
                </div>
                <div class="pt-2 h-full min-h-[24rem] relative ">
