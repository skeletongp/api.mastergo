                ...
                <div class="w-full max-w-xl space-y-4">
                    <div class="w-full grid grid-cols-3 items-end  gap-4">
                        <div class="col-span-1">
                            <x-base-input class="text-base uppercase" wire:model.lazy="outncf" id="outncf"
                                type="text" label="Buscar gasto por NCF"></x-base-input>
                        </div>
                        <div class="col-span-1">
                            <x-base-input class="text-base uppercase" wire:model="total" readonly
                                id="outtotal" type="text" label="Total"></x-base-input>
                        </div>
                        <div class="col-span-1">
                            <x-base-input class="text-base uppercase" wire:model="itbis" id="outncf"
                                type="text" disabled label="ITBIS"></x-base-input>
                        </div>
                        <div class="col-span-1">
                            <x-base-input class="text-base uppercase" wire:model.defer="credit.ncf" id="ncf"
                                type="text"  label="NCF "></x-base-input>
                        </div>
                        ...
                        <div class="col-span-1">
                            <x-base-input type="date" id="outDate" label="" wire:model.lazy="credit.modified_at">
                            </x-base-input>
                        </div>
