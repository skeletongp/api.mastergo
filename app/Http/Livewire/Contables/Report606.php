...
class Report606 extends Component
{
    ...
    public function make606()
    {
        ...
        $outcomes=Outcome::where('outcomes.store_id',$store->id)
            ...
            ->selectRaw('outcomes.*, providers.rnc as rnc, outcomes.updated_at as day, payments.efectivo as efectivo, payments.tarjeta, payments.transferencia as transferencia, payments.tax as tax, providers.fullname as provider')
            ->groupBy('outcomes.id')
            ->orderBy('payments.id')
            ->get();
